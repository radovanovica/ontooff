            ...
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  <Typography variant="body2">
                    {booking.activityLocation?.activityTypes.filter((a: { activityLocationId: string, activityType: { name: string, id: string } }) => booking.activityLocationId === a.activityLocationId)
